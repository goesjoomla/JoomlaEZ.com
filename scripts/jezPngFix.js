function jezFixPNGs(){if(window.attachEvent&&jezIEVer<=6){var images=document.images;for(var i=0;i<images.length;i++)
jezFixPNG(images[i]);setTimeout("jezShowPNGs()",200);}}
