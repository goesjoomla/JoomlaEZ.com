...
?>
<div id="jezComOutput" class="user_reset<?php echo $this->escape($this->params->get('pageclass_sfx')); ?> tr">
...
<p class="intro"><?php echo JText::_('RESET_PASSWORD_REQUEST_DESCRIPTION'); ?></p>
<fieldset>
<div class="tr">
